...
#define DWT_CYCCNT \
    (volatile uint32_t *) (DWT_BASE + 0x04) /*!< Cycle Count Register */
#define DWT_CPICNT \
    (volatile uint32_t *) (DWT_BASE + 0x08) /*!< CPI Count Register */
#define DWT_EXCCNT                    \
    (volatile uint32_t *) (DWT_BASE + \
                           0x0c) /*!< Exception Overhead Count Register */
#define DWT_SLEEPCNT \
    (volatile uint32_t *) (DWT_BASE + 0x10) /*!< Sleep Count Register */
#define DWT_LSUCNT \
    (volatile uint32_t *) (DWT_BASE + 0x14) /*!< LSU Count Register */
#define DWT_FOLDCNT                   \
    (volatile uint32_t *) (DWT_BASE + \
                           0x18) /*!< Folded-instruction Count Register */
#define DWT_PCSR                      \
    (volatile uint32_t *) (DWT_BASE + \
                           0x1c) /*!< Program Counter Sample Register */
#define DWT_COMP \
    (volatile dwt_comp_t *) (DWT_BASE + 0x20) /*!< Comparator Registers */

/* DWT Comparator Function Register */
#define DWT_FUNC_DISABLE (uint32_t) (0 << 0) /*!< Comparator disabled */
#define DWT_FUNC_DADDR_RO \
    (uint32_t) (5 << 0) /*!< Watch read-only data-access */
#define DWT_FUNC_DADDR_WO \
    (uint32_t) (6 << 0) /*!< Watch write-only data-access */
#define DWT_FUNC_DADDR_RW \
    (uint32_t) (7 << 0) /*!< Watch read-write data-access */
#define DWT_FUNC_CYCMATCH \
    (uint32_t) (1 << 7) /*!< Enable cycle count comparison */
#define DWT_FUNC_DATAVMATCH \
    (uint32_t) (1 << 8) /*!< Enable data value comparison */
#define DWT_FUNC_DATASZ_BYTE \
    (uint32_t) (0 << 10) /*!< Size of data compared: 00 = Byte */
#define DWT_FUNC_DATASZ_HWORD \
    (uint32_t) (1 << 10) /*!< Size of data compared: 01 = Half-Word */
#define DWT_FUNC_DATASZ_WORD \
    (uint32_t) (2 << 10) /*!< Size of data compared: 10 = Word */
#define DWT_FUNC_MATCHED \
    (uint32_t) (1 << 24) /*!< Operation defined by FUNC matched */
