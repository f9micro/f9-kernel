...
{
    L4_ThreadId_t dummy;
    return L4_Ipc(to, to, L4_Timeouts(SndTimeout, RcvTimeout), &dummy);
}
...
{
    return L4_Ipc(to, L4_nilthread, (L4_Word_t) SndTimeout.raw,
                  (L4_ThreadId_t *) 0);
}
...
L4_INLINE L4_MsgTag_t L4_Wait_Timeout(L4_Time_t RcvTimeout, L4_ThreadId_t *from)
{
...
L4_INLINE L4_MsgTag_t L4_ReplyWait_Timeout(L4_ThreadId_t to,
                                           ...
                                           L4_ThreadId_t *from)
{
    return L4_Ipc(to, L4_anythread, L4_Timeouts(L4_ZeroTime, RcvTimeout), from);
}
