...
L4_INLINE L4_Bool_t L4_IsMsgTagEqual(const L4_MsgTag_t l, const L4_MsgTag_t r)
{
    return l.raw == r.raw;
}
...
L4_INLINE void __L4_Copy_String(L4_StringItem_t *d, L4_StringItem_t *s)
{
...
L4_INLINE void L4_FaultConfCtrlXferItemInit(L4_CtrlXferItem_t *c,
                                            L4_Word_t fault_id,
...
L4_INLINE L4_CacheAllocationHint_t
L4_CacheAlloctionHint(const L4_StringItem_t s)
{
...
L4_INLINE L4_StringItem_t
L4_AddCacheAllocationHint(const L4_StringItem_t dest,
...
L4_INLINE L4_StringItem_t
L4_AddCacheAllocationHintTo(L4_StringItem_t *dest,
                            const L4_CacheAllocationHint_t h)
{
...
L4_INLINE void L4_MsgPut(L4_Msg_t *msg,
                         L4_Word_t label,
                         int u,
                         L4_Word_t *Untyped,
                         int t,
...
L4_INLINE void L4_MsgGet(const L4_Msg_t *msg, L4_Word_t *Untyped, void *Items)
{
    int i, u, t;
    u = msg->tag.X.u;
    t = msg->tag.X.t;
...
L4_INLINE void L4_MsgAppendStringItem(L4_Msg_t *msg, L4_StringItem_t *s)
{
    L4_StringItem_t *d =
        (L4_StringItem_t *) &msg->msg[msg->tag.X.u + msg->tag.X.t + 1];
...
L4_INLINE void L4_AppendFaultConfCtrlXferItems(L4_Msg_t *msg,
...
L4_INLINE void L4_MsgPutGrantItem(L4_Msg_t *msg, L4_Word_t t, L4_GrantItem_t g)
{
    msg->msg[msg->tag.X.u + t + 1] = g.raw[0];
    msg->msg[msg->tag.X.u + t + 2] = g.raw[1];
}

L4_INLINE void L4_MsgPutSimpleStringItem(L4_Msg_t *msg,
                                         L4_Word_t t,
                                         L4_StringItem_t s)
{
    s.X.c = 0;
...
L4_INLINE void L4_MsgPutStringItem(L4_Msg_t *msg,
                                   L4_Word_t t,
                                   L4_StringItem_t *s)
{
...
L4_INLINE void L4_MsgPutCtrlXferItem(L4_Msg_t *msg,
                                     L4_Word_t t,
                                     L4_CtrlXferItem_t *c)
{
    L4_Word_t reg = 0, num = 0, mask = c->X.mask;
...
L4_INLINE L4_Word_t L4_MsgGetMapItem(L4_Msg_t *msg,
                                     L4_Word_t t,
                                     L4_MapItem_t *m)
{
...
L4_INLINE L4_Word_t L4_MsgGetGrantItem(L4_Msg_t *msg,
                                       L4_Word_t t,
                                       L4_GrantItem_t *g)
{
...
L4_INLINE L4_Word_t L4_MsgGetStringItem(L4_Msg_t *msg,
                                        L4_Word_t t,
                                        L4_StringItem_t *s)
{
...
L4_INLINE L4_Word_t L4_MsgGetCtrlXferItem(L4_Msg_t *msg,
                                          L4_Word_t mr,
                                          L4_CtrlXferItem_t *c)
{
...
L4_INLINE L4_Acceptor_t L4_AddAcceptorTo(L4_Acceptor_t l, const L4_Acceptor_t r)
{
    l.X.s = (l.X.s | r.X.s);
    if (r.X.RcvWindow != 0)
...
L4_INLINE void L4_AcceptStrings(const L4_Acceptor_t a, L4_MsgBuffer_t *b)
{
    const L4_StringItem_t *prev, *t,
        *s = (const L4_StringItem_t *) &b->string[0];
    int n, i = 1;
