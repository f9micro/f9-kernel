...
L4_INLINE L4_Bool_t L4_IsMsgTagEqual(
		const L4_MsgTag_t l, const L4_MsgTag_t r)
{
	return l.raw == r.raw;
}

L4_INLINE L4_Bool_t L4_IsMsgTagNotEqual(
		const L4_MsgTag_t l, const L4_MsgTag_t r)
{
	return l.raw != r.raw;
}

L4_INLINE L4_MsgTag_t L4_MsgTagAddLabel(
		const L4_MsgTag_t t, int label)
{
	L4_MsgTag_t tag = t;
	tag.X.label = label;
	return tag;
...
L4_INLINE L4_StringItem_t *__L4_EndOfString(
...
L4_INLINE L4_StringItem_t *__L4_EndOfStrings(
		L4_StringItem_t *s, L4_StringItem_t **p)
{
	L4_StringItem_t *prev;
	do {
...
L4_INLINE void __L4_Copy_String(
		L4_StringItem_t *d, L4_StringItem_t *s)
{
...
L4_INLINE L4_StringItem_t *L4_AddSubstringTo(
		L4_StringItem_t *dest, L4_StringItem_t *substr)
{
	L4_StringItem_t *prev;
...
L4_INLINE L4_StringItem_t *L4_AddSubstringAddressTo(
		L4_StringItem_t *dest, void *substring_addr)
{
...
L4_INLINE void L4_FaultConfCtrlXferItemInit(
		L4_CtrlXferItem_t *c, L4_Word_t fault_id,
...
L4_INLINE void L4_MsgGet(
		const L4_Msg_t *msg, L4_Word_t *Untyped,
		void *Items)
{
	int i, u, t;
	u = msg->tag.X.u;
...
L4_INLINE void L4_MsgAppendStringItem(
		L4_Msg_t *msg, L4_StringItem_t *s)
{
...
L4_INLINE void L4_MsgAppendCtrlXferItem(L4_Msg_t *msg, L4_CtrlXferItem_t *c)
{
	...
	for (reg += __L4_Lsb(mask); mask != 0;
			mask >>= __L4_Lsb(mask) + 1, reg += __L4_Lsb(mask) + 1, num++)
...
L4_INLINE void L4_AppendFaultConfCtrlXferItems(
		L4_Msg_t *msg,
...
L4_INLINE void L4_MsgPutGrantItem(
		L4_Msg_t *msg, L4_Word_t t,
		L4_GrantItem_t g)
{
...
L4_INLINE void L4_MsgPutSimpleStringItem(
		L4_Msg_t *msg, L4_Word_t t,
		L4_StringItem_t s)
{
	s.X.c = 0;
...
L4_INLINE void L4_MsgPutStringItem(
		L4_Msg_t *msg, L4_Word_t t,
		L4_StringItem_t * s)
{
...
L4_INLINE L4_Word_t L4_MsgGetMapItem(
		L4_Msg_t *msg, L4_Word_t t,
		L4_MapItem_t *m)
{
...
L4_INLINE L4_Word_t L4_MsgGetGrantItem(
		L4_Msg_t *msg, L4_Word_t t,
		L4_GrantItem_t *g)
{
...
L4_INLINE L4_Word_t L4_MsgGetStringItem(
		L4_Msg_t *msg, L4_Word_t t,
		L4_StringItem_t *s)
{
...
L4_INLINE L4_Acceptor_t L4_AddAcceptor(
		const L4_Acceptor_t l, const L4_Acceptor_t r)
{
	L4_Acceptor_t a;
	a.raw = 0;
	a.X.s = (l.X.s | r.X.s);
...
L4_INLINE L4_Acceptor_t L4_AddAcceptorTo(
		L4_Acceptor_t l, const L4_Acceptor_t r)
{
	l.X.s = (l.X.s | r.X.s);
	if (r.X.RcvWindow != 0)
...
L4_INLINE L4_Acceptor_t L4_RemoveAcceptor(
		const L4_Acceptor_t l, const L4_Acceptor_t r)
{
	L4_Acceptor_t a = l;
	if (r.X.s)
...
L4_INLINE L4_Acceptor_t L4_RemoveAcceptorFrom(
		L4_Acceptor_t l, const L4_Acceptor_t r)
{
	if (r.X.s)
		l.X.s = 0;
...
L4_INLINE void L4_AcceptStrings(
		const L4_Acceptor_t a, L4_MsgBuffer_t *b)
{
...
L4_INLINE void L4_MsgBufferAppendSimpleRcvString(
...
L4_INLINE void L4_MsgBufferAppendRcvString(
		L4_MsgBuffer_t *b, L4_StringItem_t *s)
{
	L4_StringItem_t *prev, *tmp;
