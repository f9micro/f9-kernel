...
L4_INLINE L4_Word_t L4_Set_Timeslice(L4_ThreadId_t tid,
                                     L4_Time_t timeslice,
...
L4_INLINE L4_Word_t L4_Timeslice(L4_ThreadId_t tid,
                                 L4_Time_t *timeslice,
                                 L4_Time_t *totalquantum)
{
                                   ...
                                   L4_Word_t *old_control)
{
    ...
    return L4_Schedule(tid, time_control, ~0UL, prio_control,
                       preemption_control, old_control);
}
