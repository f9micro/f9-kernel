...
#define L4_BITFIELD2(t, a, b) \
    t b;                      \
    t a
#define L4_BITFIELD3(t, a, b, c) \
    t c;                         \
    t b;                         \
    t a
#define L4_BITFIELD4(t, a, b, c, d) \
    t d;                            \
    t c;                            \
    t b;                            \
    t a
#define L4_BITFIELD5(t, a, b, c, d, e) \
    t e;                               \
    t d;                               \
    t c;                               \
    t b;                               \
    t a
#define L4_BITFIELD6(t, a, b, c, d, e, f) \
    t f;                                  \
    t e;                                  \
    t d;                                  \
    t c;                                  \
    t b;                                  \
    t a
#define L4_BITFIELD7(t, a, b, c, d, e, f, g) \
    t g;                                     \
    t f;                                     \
    t e;                                     \
    t d;                                     \
    ...
    t b;                                     \
    t a
#define L4_BITFIELD8(t, a, b, c, d, e, f, g, h) \
    t h;                                        \
    t g;                                        \
    t f;                                        \
    t e;                                        \
...
typedef union {
    L4_Word_t raw;
    struct {
        L4_BITFIELD4(L4_Word_t, rwx : 3, extended : 1, s : 6, b : 22 __PLUS32);
    } X;
} L4_Fpage_t;
...
typedef union {
    L4_Word_t raw;
    struct {
        L4_BITFIELD2(L4_Word_t, __zeros : 6, local_id : 26 __PLUS32);
    } X;
} L4_LthreadId_t;
...
#define L4_anylocalthread                                                      \
    ((L4_ThreadId_t) {                                                         \
        local :                                                                \
            {X : {L4_SHUFFLE2(0, ((1UL << (8 * sizeof(L4_Word_t) - 6)) - 1))}} \
    })
...
typedef union {
    L4_Word16_t raw;
    struct {
        L4_BITFIELD3(L4_Word_t, m : 10, e : 5, a : 1);
    } period;
    struct {
        L4_BITFIELD4(L4_Word_t, m : 10, c : 1, e : 4, a : 1);
    } point;
} L4_Time_t;
...
#define __L4_TRY_EXPONENT(N)            \
    ...
    if (__builtin_constant_p(microseconds)) {
        ...
        __L4_TRY_EXPONENT(10);
        __L4_TRY_EXPONENT(11);
        __L4_TRY_EXPONENT(12);
        __L4_TRY_EXPONENT(13);
        __L4_TRY_EXPONENT(14);
        __L4_TRY_EXPONENT(15);
        __L4_TRY_EXPONENT(16);
        __L4_TRY_EXPONENT(17);
        __L4_TRY_EXPONENT(18);
        __L4_TRY_EXPONENT(19);
        __L4_TRY_EXPONENT(20);
        __L4_TRY_EXPONENT(21);
        __L4_TRY_EXPONENT(22);
        __L4_TRY_EXPONENT(23);
        __L4_TRY_EXPONENT(24);
        __L4_TRY_EXPONENT(25);
        __L4_TRY_EXPONENT(26);
        __L4_TRY_EXPONENT(27);
        __L4_TRY_EXPONENT(28);
        __L4_TRY_EXPONENT(29);
        __L4_TRY_EXPONENT(30);
        __L4_TRY_EXPONENT(31);
        else return L4_Never;
    } else {
        L4_Word_t l4_exp = 0;
