...
L4_INLINE L4_ThreadId_t L4_GlobalIdOf(L4_ThreadId_t t)
{
    ...
    if (L4_IsLocalId(t))
        return L4_ExchangeRegisters(t, 0, 0, 0, 0, 0, L4_nilthread, &dummy,
                                    &dummy, &dummy, &dummy, &dummy, &dummy_id);
    else
        return t;
}
...
L4_INLINE L4_Word_t L4_UserDefinedHandleOf(L4_ThreadId_t t)
{
    ...
    (void) L4_ExchangeRegisters(t, (1 << 9), 0, 0, 0, 0, L4_nilthread, &dummy,
                                &dummy, &dummy, &dummy, &handle, &dummy_id);
...
L4_INLINE void L4_Set_PagerOf(L4_ThreadId_t t, L4_ThreadId_t p)
{
    ...
    (void) L4_ExchangeRegisters(t, (1 << 7), 0, 0, 0, 0, p, &dummy, &dummy,
...
L4_INLINE void L4_Start_SpIpFlags(L4_ThreadId_t t,
                                  L4_Word_t sp,
                                  L4_Word_t ip,
                                  L4_Word_t flags)
{
                                             ...
                                             L4_Word_t *flags)
{
    ...
    (void) L4_ExchangeRegisters(t, 1 + (1 << 8) + (1 << 9), 0, 0, 0, 0,
                                L4_nilthread, &state.raw, sp, ip, flags, &dummy,
                                &dummy_id);
...
L4_INLINE L4_ThreadState_t L4_AbortReceive_and_stop_SpIpFlags(L4_ThreadId_t t,
                                                              L4_Word_t *sp,
                                                              L4_Word_t *ip,
                                                              L4_Word_t *flags)
{
...
L4_INLINE L4_ThreadState_t L4_AbortSend_and_stop_SpIpFlags(L4_ThreadId_t t,
                                                           L4_Word_t *sp,
                                                           L4_Word_t *ip,
                                                           L4_Word_t *flags)
{
...
L4_INLINE L4_Word_t L4_ConfCtrlXferItems(L4_ThreadId_t dest)
{
    ...
    L4_ExchangeRegisters(dest, L4_EXREGS_CTRLXFER_CONF_FLAG, 0, 0, 0, 0,
                         L4_nilthread, &old_control, &dummy, &dummy, &dummy,
                         &dummy, &dummy_tid);
    return old_control;
}
...
L4_INLINE L4_Word_t L4_ReadCtrlXferItems(L4_ThreadId_t dest)
{
    L4_Word_t dummy, old_control;
    L4_ThreadId_t dummy_tid;
    L4_ExchangeRegisters(dest, L4_EXREGS_CTRLXFER_READ_FLAG, 0, 0, 0, 0,
                         L4_nilthread, &old_control, &dummy, &dummy, &dummy,
                         &dummy, &dummy_tid);
    return old_control;
}
...
L4_INLINE L4_Word_t L4_WriteCtrlXferItems(L4_ThreadId_t dest)
{
    L4_Word_t dummy, old_control;
    L4_ThreadId_t dummy_tid;
    L4_ExchangeRegisters(dest, L4_EXREGS_CTRLXFER_WRITE_FLAG, 0, 0, 0, 0,
                         L4_nilthread, &old_control, &dummy, &dummy, &dummy,
                         &dummy, &dummy_tid);
    return old_control;
}
