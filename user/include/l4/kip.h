...
typedef union {
    L4_Word_t raw;
    struct {
        L4_BITFIELD3(L4_Word_t, ee : 2, ww : 2, __padding : 28 __PLUS32);
    } x;
} L4_ApiFlags_t;
...
typedef struct {
    ...
    union {
        L4_Word_t raw;
        struct {
            L4_BITFIELD2(L4_Word_t, s : 6, __padding : 26 __PLUS32);
        } X;
    } KipAreaInfo;
...
L4_INLINE void L4_KernelGenDate(void *KernelInterface,
                                L4_Word_t *year,
                                L4_Word_t *month,
                                L4_Word_t *day)
{
...
typedef union {
    ...
    struct {
        ...
        L4_BITFIELD2(L4_Word_t, __padding2 : 10, high : L4_BITS_PER_WORD - 10);
    } x;
} L4_MemoryDesc_t;
...
L4_INLINE L4_MemoryDesc_t *L4_MemoryDesc(void *KernelInterface, L4_Word_t num)
{
    L4_KernelInterfacePage_t *kip;
    kip = (L4_KernelInterfacePage_t *) KernelInterface;
    ...
    return (L4_MemoryDesc_t *) ((L4_Word_t) kip + kip->MemoryInfo.MemDescPtr) +
           num;
}
