...
//		ioe_gpio_init();
        RCC_AHB1PeriphClockCmd(RCC_APB1ENR_I2C3EN, 1);
...
#define APB1_DEV_SIZE 0x7800
#define APB1DEV 0x40000000
...
DECLARE_USER(
    ...
    /* map thread with APB DEVICE for I2C accessing */
	DECLARE_FPAGE(APB1DEV, APB1_DEV_SIZE)
