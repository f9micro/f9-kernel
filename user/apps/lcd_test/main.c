...
DECLARE_USER(4,
             ...
             DECLARE_FPAGE(0x0, 2 * (UTCB_SIZE + STACK_SIZE))
                 DECLARE_FPAGE(0x0, 512) DECLARE_FPAGE(0x40005000, 0x1000)
                     DECLARE_FPAGE(0x40015000, 0x0c00) DECLARE_FPAGE(0x40020000,
                                                                     0x3c00)
                         DECLARE_FPAGE(0x40028000,
                                       0x8000) DECLARE_FPAGE(0x42470000, 0x0c00)
