...
__USER_TEXT void *L4_KernelInterface(
...
__USER_TEXT L4_ThreadId_t L4_ExchangeRegisters(
		L4_ThreadId_t dest,
		L4_Word_t control,
		L4_Word_t sp,
		L4_Word_t ip,
...
__USER_TEXT L4_Word_t L4_Schedule(
		L4_ThreadId_t dest,
...
__USER_TEXT L4_MsgTag_t L4_Ipc(
		L4_ThreadId_t to,
...
__USER_TEXT L4_MsgTag_t L4_Lipc(
		L4_ThreadId_t to,
		L4_ThreadId_t FromSpecifier,
		L4_Word_t Timeouts,
		L4_ThreadId_t *from)
...
__USER_TEXT L4_Word_t L4_SpaceControl(
		L4_ThreadId_t SpaceSpecifier,
		L4_Word_t control,
...
__USER_TEXT L4_Word_t L4_ProcessorControl(
...
__USER_TEXT L4_Word_t L4_MemoryControl(
		L4_Word_t control,
