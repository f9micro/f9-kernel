...
void __USER_TEXT lcd_ctrllines_init(void)
{
    ...
    gpio_config_output(LCD_NCS_GPIO_PORT, LCD_NCS_PIN, GPIO_PUPDR_NONE,
                       GPIO_OSPEEDR_50M);
    gpio_config_output(LCD_WRX_GPIO_PORT, LCD_WRX_PIN, GPIO_PUPDR_NONE,
                       GPIO_OSPEEDR_50M);
...
void __USER_TEXT lcd_draw_line(uint16_t x,
                               uint16_t y,
                               uint16_t length,
                               uint8_t direction)
{
...
void __USER_TEXT lcd_draw_rect(uint16_t x,
                               uint16_t y,
                               uint16_t height,
                               uint16_t width)
{
...
void __USER_TEXT lcd_fill_rect(uint16_t x,
                               uint16_t y,
                               uint16_t height,
                               uint16_t width)
{
